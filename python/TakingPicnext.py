...
while True:
    print("Press 's' to capture the next move or 'q' to quit.")
    while True:
    ...
    score = tictactoe.evaluate(tictactoe.board)
    if score == 10:
        print("AI wins!")
        break
    elif score == -10:
        print("Opponent wins!")
        break
    elif not tictactoe.isMovesLeft(tictactoe.board):
        print("It's a draw!")
        break
