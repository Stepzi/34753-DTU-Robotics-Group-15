...
def main():
    ...
    t1 = arm.joint_polyTraj(frame_no=4, 
                          A={'gamma': 0, 'origin': [0,0.15,0.15], 'elbow':"up", 'v': [0,0,0], 'gamma_d': 0},
                          B={'gamma': -np.deg2rad(30), 'origin': [0,0.1,0.2], 'elbow':"up", 'v': [0,0,0], 'gamma_d': 0},
                          tA = 0,
                          tB = 3,
                          order = 1)
    t2 = arm.joint_polyTraj(frame_no=4, 
                          A={'gamma': -np.deg2rad(30), 'origin': [0,0.1,0.2], 'elbow':"up", 'v': [0,0,0], 'gamma_d': 0},
                          B={'gamma': 0, 'origin': [0,0.15,0.15], 'elbow':"up", 'v': [0,0,0], 'gamma_d': 0},
                          tA = 0,
                          tB = 5,
                          order = 3)
    t3 = arm.joint_polyTraj(frame_no=4, 
                          A={'gamma': 0, 'origin': [0,0.15,0.15], 'elbow':"up", 'v': [0,0,0], 'gamma_d': 0},
                          B={'gamma': -np.deg2rad(90), 'origin': [0,0.15,0.05], 'elbow':"up", 'v': [0,0,0], 'gamma_d': 0},
                          tA = 0,
                          tB = 5,
                          order = 5)
    t4 = arm.joint_polyTraj(frame_no=4, 
                          A={'gamma': -np.deg2rad(90), 'origin': [0,0.15,0.05], 'elbow':"up", 'v': [0,0,0], 'gamma_d': 0},
                          B={'gamma': 0, 'origin': [0,0.15,0.15], 'elbow':"up", 'v': [0,0,0], 'gamma_d': 0},
                          tA = 0,
                          tB = 5,
                          order = 5)
